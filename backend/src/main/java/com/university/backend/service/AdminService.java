...
import com.university.backend.entity.Department;
import com.university.backend.entity.DepartmentStatus;
...
public class AdminService {
    ...
    public User createUser(CreateUserRequest request) {
        ...
        User user = User.builder()
            ...
            .enrollmentDate(request.getRole() == Role.STUDENT ? LocalDate.now() : null)
            .build();
