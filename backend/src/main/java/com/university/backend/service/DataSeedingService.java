    ...
    private void seedAcademicSemesters() {
        ...
        List<AcademicSemester> semesters = Arrays.asList(
            AcademicSemester.builder()
                ...
                .finalExamStart(LocalDate.of(2024, 12, 10))
                .finalExamEnd(LocalDate.of(2024, 12, 15))
            ...
            AcademicSemester.builder()
                ...
                .finalExamStart(LocalDate.of(2025, 5, 10))
                .finalExamEnd(LocalDate.of(2025, 5, 15))
            ...
            AcademicSemester.builder()
                ...
                .finalExamStart(LocalDate.of(2025, 8, 10))
                .finalExamEnd(LocalDate.of(2025, 8, 15))
            ...
            AcademicSemester.builder()
                ...
                .finalExamStart(LocalDate.of(2025, 12, 10))
                .finalExamEnd(LocalDate.of(2025, 12, 15))
