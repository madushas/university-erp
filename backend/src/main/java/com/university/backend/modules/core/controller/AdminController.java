...
import com.university.backend.dto.response.PagedResponse;
import com.university.backend.dto.response.UserResponse;
import com.university.backend.modules.core.entity.User;
import com.university.backend.modules.core.service.AdminService;
...
public class AdminController {
    ...
    public ResponseEntity<com.university.backend.dto.response.RegistrationResponse> updateRegistrationStatus(
            @PathVariable Long id,
            @RequestParam String status) {
        com.university.backend.dto.response.RegistrationResponse registration = 
    ...
    public ResponseEntity<Void> unenrollStudent(
            @PathVariable Long id) {
        adminService.unenrollStudent(id);
        return ResponseEntity.noContent().build();
    }
