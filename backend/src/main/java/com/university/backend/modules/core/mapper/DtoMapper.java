...
public class DtoMapper {
    ...
    public CourseDto toCourseDto(Course course) {
        ...
        return CourseDto.builder()
                ...
                .instructorName(course.getInstructor() != null ? course.getInstructor().getFirstName() + " " + course.getInstructor().getLastName() : null)
                .instructorEmail(course.getInstructor() != null ? course.getInstructor().getEmail() : course.getInstructorEmail())
