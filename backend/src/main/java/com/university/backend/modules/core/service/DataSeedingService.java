...
public class DataSeedingService implements CommandLineRunner {
    ...
    private User createDefaultInstructor() {
    ...
    private List<Course> createCourses() {
        // Find or create instructor users
        User defaultInstructor = userRepository.findByUsername("dr_smith")
            .orElse(createDefaultInstructor());
        ...
        return Arrays.asList(
            ...
            Course.builder()
                ...
                .instructorEmail(defaultInstructor.getEmail())
                .department("CS")
